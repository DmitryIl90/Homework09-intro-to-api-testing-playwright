...
test('Order was updated successfully with valid API key and id and return status code OK', async  ({ request }) => {
...
test('Order was updated unsuccessfully with missing API key and return status code Unauthorized', async  ({ request }) => {
  const requestBody = {
    status: 'OPEN',
    courierId: 0,
    customerName: 'Dmitry',
